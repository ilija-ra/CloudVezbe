...
namespace ValidatorStatefulService
{
    ...
    internal sealed class ValidatorStatefulService : StatefulService, IBookAsync
    {
        ...
        public async Task<List<string>> GetAllBooksAsync()
        {
            ...
            {
                new Book(){ Id = 1, Title = "To Kill a Mockingbird", Author = "Harper Lee", PagesNumber = 281, PublicationYear = 1960, Price = 9.99 },
                new Book(){ Id = 2, Title = "1984", Author = "George Orwell", PagesNumber = 328, PublicationYear = 1949, Price = 10.60 },
                new Book(){ Id = 3, Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", PagesNumber = 180, PublicationYear = 1925, Price = 22.35 },
                new Book(){ Id = 4, Title = "The Hobbit", Author = "J.R.R. Tolkien", PagesNumber = 310 , PublicationYear = 1937, Price = 50.00 },
                new Book(){ Id = 5, Title = "Pride and Prejudice", Author = "Jane Austen", PagesNumber = 279, PublicationYear = 1813, Price = 14.85 }
            };
            ...
            using (var transaction = stateManager.CreateTransaction())
            {
                ...
                while (await enumerator.MoveNextAsync(CancellationToken.None))
                {
                    ...
                    // Convert the Book object to JSON and add it to the list
